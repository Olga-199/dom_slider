...
function initSlider() {
    ...
    const mediaDiv = document.querySelector(".slider-media");
    const sliderImg = mediaDiv.querySelector(".slider-imgs");
    const navDiv = document.querySelector(".slider-navigation-buttons");
    const aboutProject = document.querySelector(".slider-description-completed-about");
